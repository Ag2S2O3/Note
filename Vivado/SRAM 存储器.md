...
- [一、EGO1-SRAM 特性](#一-ego1-sram-特性)
  - [1.1 功能框图](#11-功能框图)
  - [1.2 真值表](#12-真值表)
  - [1.3 数据读取（READ）](#13-数据读取read)
  - [1.4 数据写入（WRITE）](#14-数据写入write)
- [二、实战应用——Verilog实现SRAM储存器访问](#二-实战应用verilog实现sram储存器访问)
  - [2.1 译码模块](#21-译码模块)
  - [2.2 数码管显示模块](#22-数码管显示模块)
  - [2.3 按键消抖模块](#23-按键消抖模块)
  - [2.4 控制SRAM](#24-控制sram)
    - [2.4.1 读写状态机](#241-读写状态机)
    - [2.4.2 片上连线](#242-片上连线)
- [*三、拓展——将程序烧录进片上ROM中](#三-拓展将程序烧录进片上rom中)
...
通过将程序烧录进ROM以解决掉电程序丢失的问题，具体操作如下：

**1. 生成bit文件（像以往一样）**

![](images/2024-06-03-21-11-20.png)

**2. 在生成完毕的窗口 或者 在*tools*选项卡中找到*generate Memory Configuration Flie***

![](images/2024-06-03-21-13-36.png)

**3. 对文件进行配置，按照图片中所述**

![](images/2024-06-03-21-18-29.png)

**4. 出现弹窗，确认即可**

![](images/2024-06-03-21-19-01.png)

**5. 打开*Hardware Manager*，连接设备后点击*Add Configuration Memory Device***

![](images/2024-06-03-21-21-29.png)

**6. 点击打开选项窗口**

![](images/2024-06-03-21-22-07.png)

**7. 选择器件型号**

![](images/2024-06-03-21-23-17.png)

**8. 选择刚刚生成的bin文件烧录**

![](images/2024-06-03-21-24-12.png)

**9. 等待烧录完成**

![](images/2024-06-03-21-24-26.png)

**10. 拔掉跳线帽，重新上电等待即可看到之前烧录的程序**

![](images/2024-06-03-21-27-26.png)